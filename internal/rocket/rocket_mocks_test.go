...
// Source: github.com/X-ecute/go-grpc/internal/rocket (interfaces: Store)
...
func (m *MockStore) GetRocketById(arg0 int) (Rocket, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateRocket(arg0 Rocket) (Rocket, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateRocket", arg0)
	ret0, _ := ret[0].(Rocket)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) UpdateRocket(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateRocket", reflect.TypeOf((*MockStore)(nil).UpdateRocket), arg0)
}
