...
const (
	RocketService_GetRocket_FullMethodName    = "/rocket.v1.RocketService/GetRocket"
	RocketService_AddRocket_FullMethodName    = "/rocket.v1.RocketService/AddRocket"
	RocketService_DeleteRocket_FullMethodName = "/rocket.v1.RocketService/DeleteRocket"
)
...
func (c *rocketServiceClient) GetRocket(ctx context.Context, in *GetRocketRequest, opts ...grpc.CallOption) (*GetRocketResponse, error) {
	...
	err := c.cc.Invoke(ctx, RocketService_GetRocket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rocketServiceClient) AddRocket(ctx context.Context, in *AddRocketRequest, opts ...grpc.CallOption) (*AddRocketResponse, error) {
	...
	err := c.cc.Invoke(ctx, RocketService_AddRocket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rocketServiceClient) DeleteRocket(ctx context.Context, in *DeleteRocketRequest, opts ...grpc.CallOption) (*DeleteRocketResponse, error) {
	...
	err := c.cc.Invoke(ctx, RocketService_DeleteRocket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRocketServiceServer must be embedded to have
...
func (UnimplementedRocketServiceServer) testEmbeddedByValue()                       {}
...
func RegisterRocketServiceServer(s grpc.ServiceRegistrar, srv RocketServiceServer) {
	// If the following call pancis, it indicates UnimplementedRocketServiceServer was
